...
public class MonalRenderer extends GeoEntityRenderer<MonalEntity> {
    ...
    public MonalRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new MonalModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(MonalEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
