...
public class LapwingRenderer extends GeoEntityRenderer<LapwingEntity> {
    ...
    public LapwingRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new LapwingModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(LapwingEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
