...
public class EagleOwlRenderer extends GeoEntityRenderer<EagleOwlEntity> {
    ...
    public EagleOwlRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new EagleOwlModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(EagleOwlEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
