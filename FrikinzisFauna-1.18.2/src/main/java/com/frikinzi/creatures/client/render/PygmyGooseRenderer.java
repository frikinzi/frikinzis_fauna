...
public class PygmyGooseRenderer extends GeoEntityRenderer<PygmyGooseEntity> {
    ...
    public PygmyGooseRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new PygmyGooseModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(PygmyGooseEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
