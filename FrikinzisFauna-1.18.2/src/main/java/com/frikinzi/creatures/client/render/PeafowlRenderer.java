...
public class PeafowlRenderer extends GeoEntityRenderer<PeafowlEntity> {
    ...
    public PeafowlRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new PeafowlModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(PeafowlEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
