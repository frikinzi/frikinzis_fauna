...
public class KingfisherRenderer extends GeoEntityRenderer<KingfisherEntity> {
    ...
    public KingfisherRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new KingfisherModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(KingfisherEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
