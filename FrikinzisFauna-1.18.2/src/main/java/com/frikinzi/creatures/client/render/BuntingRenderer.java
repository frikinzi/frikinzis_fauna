...
public class BuntingRenderer extends GeoEntityRenderer<BuntingEntity> {
    ...
    public BuntingRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new BuntingModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(BuntingEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
