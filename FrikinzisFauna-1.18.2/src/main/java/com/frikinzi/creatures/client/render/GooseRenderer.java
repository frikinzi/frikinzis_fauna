...
public class GooseRenderer extends GeoEntityRenderer<GooseEntity> {
    ...
    public GooseRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new GooseModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(GooseEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
