...
public class DoveRenderer extends GeoEntityRenderer<DoveEntity> {
    ...
    public DoveRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new DoveModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(DoveEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
