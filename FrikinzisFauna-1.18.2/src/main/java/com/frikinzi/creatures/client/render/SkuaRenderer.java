...
public class SkuaRenderer extends GeoEntityRenderer<SkuaEntity> {
    ...
    public SkuaRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new SkuaModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(SkuaEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
