...
public class FiddlerCrabRenderer extends GeoEntityRenderer<FiddlerCrabEntity> {
    ...
    public FiddlerCrabRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new FiddlerCrabModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void renderEarly(FiddlerCrabEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
