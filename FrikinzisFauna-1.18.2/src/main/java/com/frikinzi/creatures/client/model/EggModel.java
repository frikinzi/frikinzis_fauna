...
public class EggModel extends AnimatedTickingGeoModel<EggEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(EggEntity object) {
        return new ResourceLocation(Creatures.MODID, "geo/entity/egg/egg.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(EggEntity object) {
    ...
    @Override
    public ResourceLocation getAnimationFileLocation(EggEntity object) {
