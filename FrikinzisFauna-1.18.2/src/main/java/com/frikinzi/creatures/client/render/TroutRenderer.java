...
public class TroutRenderer extends GeoEntityRenderer<TroutEntity> {
    ...
    public TroutRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new TroutModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(TroutEntity animatable, PoseStack stack, float partialTick, MultiBufferSource bufferSource,
