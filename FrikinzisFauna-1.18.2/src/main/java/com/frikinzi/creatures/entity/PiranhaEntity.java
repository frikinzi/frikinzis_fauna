...
public class PiranhaEntity extends AbstractCreaturesFish implements IAnimatable, IAnimationTickable {
    ...
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.redbelliedpiranha"),
            2, new TranslatableComponent("message.creatures.blackdotpiranha"),
            3, new TranslatableComponent("message.creatures.blackpiranha"),
            4, new TranslatableComponent("message.creatures.pirayapiranha"),
            5, new TranslatableComponent("message.creatures.rubyredpiranha")
    );

    public PiranhaEntity(EntityType<? extends PiranhaEntity> p_29790_, Level p_29791_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<PiranhaEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public double getHatchChance() {
        return CreaturesConfig.piranha_hatch_chance.get();
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 6.0D).add(Attributes.MOVEMENT_SPEED, (double)0.1F).add(Attributes.ATTACK_DAMAGE, 2.0D);
    }
