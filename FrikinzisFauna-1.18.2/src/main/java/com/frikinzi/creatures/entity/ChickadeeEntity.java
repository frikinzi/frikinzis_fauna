...
public class ChickadeeEntity extends CreaturesFlyingBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.blackcapped"),
            2, new TranslatableComponent("message.creatures.chestnutbacked"),
            3, new TranslatableComponent("message.creatures.grayheaded")
    );

    public ChickadeeEntity(EntityType<? extends ChickadeeEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<ChickadeeEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<ChickadeeEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public ChickadeeEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        ChickadeeEntity chickadee = CreaturesEntities.CHICKADEE.get().create(p_149088_);
        chickadee.setVariant(this.getVariant());
        chickadee.setGender(this.random.nextInt(2));
        chickadee.setHeightMultiplier(getSpawnEggOffspringHeight());
        return chickadee;
    }
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof ChickadeeEntity)) {
            return false;
        } else {
            ChickadeeEntity chickadee = (ChickadeeEntity)p_30392_;
            return this.isInLove() && chickadee.isInLove();
        }
    }
