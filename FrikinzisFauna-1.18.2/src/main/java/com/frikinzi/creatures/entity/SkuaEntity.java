...
public class SkuaEntity extends CreaturesFlyingBirdEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.southpolar"),
            2, new TranslatableComponent("message.creatures.chilean"),
            3, new TranslatableComponent("message.creatures.greatskua"),
            4, new TranslatableComponent("message.creatures.brownskua")
    );

    public SkuaEntity(EntityType<? extends SkuaEntity> p_29362_, Level p_29363_) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(5, new SkuaEntity.AttackBabyGoal());
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<SkuaEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 14.0D).add(Attributes.FLYING_SPEED, (double)0.6F).add(Attributes.MOVEMENT_SPEED, (double)0.2F).add(Attributes.ATTACK_DAMAGE, 2.0D);
    }

    public static boolean checkBirdSpawnRules(EntityType<SkuaEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public SkuaEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        SkuaEntity skua = CreaturesEntities.SKUA.get().create(p_149088_);
        skua.setVariant(this.getVariant());
        skua.setGender(this.random.nextInt(2));
        skua.setHeightMultiplier(getSpawnEggOffspringHeight());
        return skua;
    }
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof SkuaEntity)) {
            return false;
        } else {
            SkuaEntity skua = (SkuaEntity)p_30392_;
            return this.isInLove() && skua.isInLove();
        }
    }
    ...
    public Ingredient getBirdFood() {
        return Ingredient.of(Items.ROTTEN_FLESH, Items.COD, Items.SALMON, Items.CHICKEN, Items.EGG, CreaturesItems.SMALL_BIRD_MEAT.get());
    }

    public ItemStack getFoodItem() {
        return new ItemStack(Items.EGG, 1);
    }
    ...
    class AttackBabyGoal extends NearestAttackableTargetGoal<LivingEntity> {
        public AttackBabyGoal() {
            super(SkuaEntity.this, LivingEntity.class, 20, true, true, (p_213616_0_) -> {
