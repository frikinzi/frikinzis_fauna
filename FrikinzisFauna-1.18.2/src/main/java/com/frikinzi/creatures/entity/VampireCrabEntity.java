...
public class VampireCrabEntity extends AbstractWalkingCreature implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public VampireCrabEntity(EntityType<? extends VampireCrabEntity> p_29790_, Level p_29791_) {
    ...
    public VampireCrabEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        VampireCrabEntity crab = CreaturesEntities.VAMPIRE_CRAB.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof VampireCrabEntity)) {
            return false;
        } else {
            VampireCrabEntity crab = (VampireCrabEntity)p_30392_;
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<VampireCrabEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkCrabSpawnRules(EntityType<VampireCrabEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
