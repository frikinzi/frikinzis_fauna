...
public class CapercaillieEntity extends CreaturesBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public CapercaillieEntity(EntityType<? extends CapercaillieEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<CapercaillieEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<CapercaillieEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public CapercaillieEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        CapercaillieEntity monal = CreaturesEntities.CAPERCAILLIE.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof CapercaillieEntity)) {
            return false;
        } else {
            CapercaillieEntity duck = (CapercaillieEntity)p_30392_;
    ...
    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
            return CreaturesSound.CAPERCAILLIE_AMBIENT; } else {
            return null;
        }
    }
    ...
    public Ingredient getBirdFood() {
        return Ingredient.of(Items.BEETROOT, Items.SWEET_BERRIES);
    }
