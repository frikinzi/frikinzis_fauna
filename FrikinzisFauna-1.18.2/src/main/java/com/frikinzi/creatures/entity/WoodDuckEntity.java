...
public class WoodDuckEntity extends CreaturesBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private int featherTime = this.random.nextInt(6000) + 6000;

    public WoodDuckEntity(EntityType<? extends WoodDuckEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<WoodDuckEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<WoodDuckEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public WoodDuckEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        WoodDuckEntity woodduck = CreaturesEntities.WOOD_DUCK.get().create(p_149088_);
        woodduck.setGender(this.random.nextInt(2));
        woodduck.setHeightMultiplier(getSpawnEggOffspringHeight());
        return woodduck;
    }
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof WoodDuckEntity)) {
            return false;
        } else {
            WoodDuckEntity woodduck = (WoodDuckEntity)p_30392_;
            return this.isInLove() && woodduck.isInLove();
        }
    }
    ...
    public Ingredient getBirdFood() {
        return Ingredient.of(Items.PUMPKIN_SEEDS, Items.WHEAT_SEEDS, Items.KELP);
    }

    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
            return this.random.nextInt(4) == 0 ? CreaturesSound.WOOD_DUCK_AMBIENT1 : CreaturesSound.WOOD_DUCK_AMBIENT2;
        }
        return null;
    }
