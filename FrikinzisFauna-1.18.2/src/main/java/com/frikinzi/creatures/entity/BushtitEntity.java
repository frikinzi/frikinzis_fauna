...
public class BushtitEntity extends CreaturesFlyingBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.longtailedtit"),
            2, new TranslatableComponent("message.creatures.longtailedtite"),
            3, new TranslatableComponent("message.creatures.blackthroat"),
            4, new TranslatableComponent("message.creatures.abushtit")
    );

    public BushtitEntity(EntityType<? extends BushtitEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<BushtitEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<BushtitEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public BushtitEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        BushtitEntity bushtit = CreaturesEntities.BUSHTIT.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof BushtitEntity)) {
            return false;
        } else {
            BushtitEntity bushtit = (BushtitEntity)p_30392_;
