...
public class GouramiEntity extends AbstractCreaturesFish implements IAnimatable, IAnimationTickable {
    ...
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.threespot"),
            2, new TranslatableComponent("message.creatures.goldgourami"),
            3, new TranslatableComponent("message.creatures.roundtailed"),
            4, new TranslatableComponent("message.creatures.pearl"),
            5, new TranslatableComponent("message.creatures.dwarf")
    );

    public GouramiEntity(EntityType<? extends GouramiEntity> p_29790_, Level p_29791_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<GouramiEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public double getHatchChance() {
        return CreaturesConfig.gourami_hatch_chance.get();
    }
