...
public class FairywrenEntity extends CreaturesFlyingBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.variegated"),
            2, new TranslatableComponent("message.creatures.splendid"),
            3, new TranslatableComponent("message.creatures.whitewinged"),
            4, new TranslatableComponent("message.creatures.blackwinged"),
            5, new TranslatableComponent("message.creatures.purplecrowned"),
            6, new TranslatableComponent("message.creatures.superb")
    );

    public FairywrenEntity(EntityType<? extends FairywrenEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<FairywrenEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<FairywrenEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public FairywrenEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        FairywrenEntity fairywren = CreaturesEntities.FAIRYWREN.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof FairywrenEntity)) {
            return false;
        } else {
            FairywrenEntity lovebird = (FairywrenEntity)p_30392_;
