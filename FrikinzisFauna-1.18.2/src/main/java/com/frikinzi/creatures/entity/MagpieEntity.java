...
public class MagpieEntity extends CreaturesFlyingBirdEntity implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.eurasianmagpie"),
            2, new TranslatableComponent("message.creatures.australianmagpie"),
            3, new TranslatableComponent("message.creatures.javan"),
            4, new TranslatableComponent("message.creatures.taiwan"),
            5, new TranslatableComponent("message.creatures.iberianmagpie"),
            6, new TranslatableComponent("message.creatures.srilanka")
    );

    public MagpieEntity(EntityType<? extends MagpieEntity> p_29362_, Level p_29363_) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<MagpieEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkBirdSpawnRules(EntityType<MagpieEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
    ...
    public MagpieEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        MagpieEntity magpie = CreaturesEntities.MAGPIE.get().create(p_149088_);
        magpie.setVariant(this.getVariant());
        magpie.setGender(this.random.nextInt(2));
        magpie.setHeightMultiplier(getSpawnEggOffspringHeight());
        return magpie;
    }
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof MagpieEntity)) {
            return false;
        } else {
            MagpieEntity magpie = (MagpieEntity)p_30392_;
