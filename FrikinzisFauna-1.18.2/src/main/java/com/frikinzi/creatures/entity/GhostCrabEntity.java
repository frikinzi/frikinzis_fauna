...
public class GhostCrabEntity extends AbstractWalkingCreature implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public static Map<Integer, TranslatableComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslatableComponent("message.creatures.redghost"),
            2, new TranslatableComponent("message.creatures.atlanticghost"),
            3, new TranslatableComponent("message.creatures.greenhorned"),
            4, new TranslatableComponent("message.creatures.purplehorned")
    );

    public GhostCrabEntity(EntityType<? extends GhostCrabEntity> p_29790_, Level p_29791_) {
    ...
    public GhostCrabEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        GhostCrabEntity crab = CreaturesEntities.GHOST_CRAB.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            return false;
        } else if (!(p_30392_ instanceof GhostCrabEntity)) {
            return false;
        } else {
            GhostCrabEntity crab = (GhostCrabEntity)p_30392_;
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<GhostCrabEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public static boolean checkCrabSpawnRules(EntityType<GhostCrabEntity> p_29424_, LevelAccessor p_29425_, MobSpawnType p_29426_, BlockPos p_29427_, Random p_29428_) {
