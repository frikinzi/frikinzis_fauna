...
public class ShrimpEntity extends AbstractCreaturesFish implements IAnimatable, IAnimationTickable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public ShrimpEntity(EntityType<? extends ShrimpEntity> p_29790_, Level p_29791_) {
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, Player.class, 10.0F, 1.5D, 1.5D));
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, KoiEntity.class, 10.0F, 1.5D, 1.5D));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<ShrimpEntity>(this, "controller", 0, this::predicate));
    }
    ...
    public double getHatchChance() {
        return CreaturesConfig.shrimp_hatch_chance.get();
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 2.0D).add(Attributes.MOVEMENT_SPEED, (double)0.2F);
    }
