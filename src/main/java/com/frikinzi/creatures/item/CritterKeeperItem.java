...
public class CritterKeeperItem extends Item {
    ...
    public CritterKeeperItem(Properties properties) {
        super(properties);
    }

    @Override
    public InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity target, InteractionHand hand) {
        if (target instanceof AbstractCrabBase fish) {
            if (stack.hasTag()) {
                player.displayClientMessage(Component.translatable("creatures.message.critter_keeper.full"), true);
...
//                }
                ...
                player.displayClientMessage(Component.translatable("creatures.message.critter_keeper.retrieve"), true);
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!item.hasTag()) {
            player.displayClientMessage(Component.translatable("creatures.message.critter_keeper.empty"), true);
            return InteractionResult.PASS;
        }
        if (!level.isClientSide()) {
            ...
            if (entity instanceof AbstractCrabBase) {
                ...
                player.displayClientMessage(Component.translatable("creatures.message.critter_keeper.released"), true);
            }
        }
        return InteractionResult.SUCCESS;
    }
