...
public class SparrowEntity extends CreaturesFlyingBird implements GeoEntity {
    ...
    public static final Map<Integer, Component> SPECIES_NAMES = ImmutableMap.<Integer, Component>builder()
            .put(1, Component.translatable("message.creatures.eurasiantree"))
            .put(2, Component.translatable("message.creatures.sudangolden"))
            .put(3, Component.translatable("message.creatures.desertsparrow"))
            .put(4, Component.translatable("message.creatures.saffronbilled"))
            .put(5, Component.translatable("message.creatures.house"))
            .put(6, Component.translatable("message.creatures.chipping"))
            .build();
    public static final Map<Integer, String> SCIENTIFIC_NAMES = ImmutableMap.<Integer, String>builder()
            .put(1, "Passer montanus")
            .put(2, "Passer luteus")
            .put(3, "Passer simplex")
            .put(4, "Arremon flavirostris")
            .put(5, "Passer domesticus")
            .put(6, "Spizella passerina")
            .build();
    ...
    public static final Map<Integer, List<Region>> REGIONS = ImmutableMap.<Integer, List<Region>>builder()
            ...
            .put(5, List.of(Region.EUROPE, Region.ASIA, Region.AFRICA, Region.NORTH_AMERICA, Region.OCEANIA))
            .put(6, List.of(Region.NORTH_AMERICA))
            .build();

    public SparrowEntity(EntityType<? extends SparrowEntity> p_i50251_1_, Level p_i50251_2_) {
    ...
    protected <E extends SparrowEntity> PlayState flyAnimController(final AnimationState<E> event)
    {
    ...
    @Override
    public SparrowEntity getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        SparrowEntity sparrowentity = CreaturesEntities.SPARROW.get().create(p_241840_1_);
    ...
    public SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.SPARROW_AMBIENT.get(); } else {
            return null;
        }
    }
