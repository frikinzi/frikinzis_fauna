...
public class CrestedPenguinEntity extends WalkingSwimmingBird implements GeoEntity {
    ...
    private static final EntityDataAccessor<Integer> VARIANT_SUBID = SynchedEntityData.defineId(CrestedPenguinEntity.class, EntityDataSerializers.INT);
    ...
    static {
        ...
        messageMap.put(1, Component.translatable("message.creatures.fiordland"));
        messageMap.put(2, Component.translatable("message.creatures.snarescrested"));
        messageMap.put(3, Component.translatable("message.creatures.erectcrested"));
        messageMap.put(4, Component.translatable("message.creatures.southernrockhopper"));
        messageMap.put(5, Component.translatable("message.creatures.easternrockhopper"));
        messageMap.put(6, Component.translatable("message.creatures.northernrockhopper"));
        messageMap.put(7, Component.translatable("message.creatures.macaroni"));
        messageMap.put(8, Component.translatable("message.creatures.royalpenguin"));
    ...
    static {
        Map<Integer, Component> messageMap = new HashMap<>();
        messageMap.put(1, Component.translatable("description.creatures.fiordland"));
        messageMap.put(2, Component.translatable("description.creatures.snarescrested"));
        messageMap.put(3, Component.translatable("description.creatures.erectcrested"));
        messageMap.put(4, Component.translatable("description.creatures.southernrockhopper"));
        messageMap.put(5, Component.translatable("description.creatures.easternrockhopper"));
        messageMap.put(6, Component.translatable("description.creatures.northernrockhopper"));
        messageMap.put(7, Component.translatable("description.creatures.macaroni"));
        messageMap.put(8, Component.translatable("description.creatures.royalpenguin"));
    ...
    protected <E extends CrestedPenguinEntity> PlayState walkAnimController(final AnimationState<E> event)
    {
        if (this.isInWater()) {
            if (this.isBaby()) {
    ...
    @Override
    public CrestedPenguinEntity getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        CrestedPenguinEntity crestedpenguin = CreaturesEntities.CRESTED_PENGUIN.get().create(p_241840_1_);
    ...
    public SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.CRESTED_PENGUIN.get(); } else {
            return null;
        }
    }
    ...
    public Component getFunFact() {
        Component translatable = DESCRIPTION.get(this.getVariant());
        if (translatable != null) {
            return translatable;
