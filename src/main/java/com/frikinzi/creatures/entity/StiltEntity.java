...
public class StiltEntity extends CreaturesFlyingBird implements GeoEntity {
    ...
    public static final Map<Integer, Component> SPECIES_NAMES = ImmutableMap.<Integer, Component>builder()
            .put(1, Component.translatable("message.creatures.blackwingedstilt"))
            .put(2, Component.translatable("message.creatures.whitebackedstilt"))
            .put(3, Component.translatable("message.creatures.piedstilt"))
            .put(4, Component.translatable("message.creatures.blackneckedstilt"))
            .put(5, Component.translatable("message.creatures.blackstilt"))
            .put(6, Component.translatable("message.creatures.bandedstilt"))
            .build();
    ...
    @Override
    public StiltEntity getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        StiltEntity rollerentity = CreaturesEntities.STILT.get().create(p_241840_1_);
    ...
    public SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.STILT_AMBIENT.get(); } else {
            return null;
        }
    }

    protected SoundEvent getHurtSound() {
        return CreaturesSound.STILT_HURT.get();
    }
    ...
    public double getHatchChance() {
        return CreaturesConfig.stilt_hatch_chance.get();
    }
    ...
    public Component getFunFact() {
        return Component.translatable("description.creatures.stilt");
    }
