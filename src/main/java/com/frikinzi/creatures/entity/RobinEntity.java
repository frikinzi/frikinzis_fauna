...
public class RobinEntity extends CreaturesFlyingBird implements GeoEntity {
    ...
    public static Map<Integer, Component> SPECIES_NAMES = ImmutableMap.of(
            1, Component.translatable("message.creatures.europeanrobin"),
            2, Component.translatable("message.creatures.roserobin"),
            3, Component.translatable("message.creatures.easternyellow"),
    ...
    public RobinEntity(EntityType<? extends RobinEntity> p_i50251_1_, Level p_i50251_2_) {
    ...
    @Override
    public RobinEntity getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        RobinEntity rollerentity = CreaturesEntities.ROBIN.get().create(p_241840_1_);
    ...
    public SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.ROBIN_AMBIENT.get(); } else {
            return null;
        }
    }
    ...
    public Component getFunFact() {
        return Component.translatable("description.creatures.robin");
    }
