...
abstract public class AbstractCrabBase extends Animal {
    ...
    private static final EntityDataAccessor<Integer> DATA_VARIANT_ID = SynchedEntityData.defineId(AbstractCrabBase.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> GENDER = SynchedEntityData.defineId(AbstractCrabBase.class, EntityDataSerializers.INT);

    public AbstractCrabBase(EntityType<? extends AbstractCrabBase> type, Level level) {
        super(type, level);
    }
    ...
    public static class CrabData extends AgeableMobGroupData {
