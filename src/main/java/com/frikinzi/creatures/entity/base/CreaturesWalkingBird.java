...
public class CreaturesWalkingBird extends CreaturesBirdEntity {
    ...
    public CreaturesWalkingBird(EntityType<? extends CreaturesWalkingBird> p_29362_, Level p_29363_) {
