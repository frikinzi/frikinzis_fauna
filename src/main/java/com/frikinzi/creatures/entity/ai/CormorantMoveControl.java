...
class CormorantMoveControl extends SmoothSwimmingMoveControl {
    private final CormorantEntity cormorant;

    public CormorantMoveControl(CormorantEntity entity) {
        super(entity, 85, 10, 0.1F, 0.5F, false);
        this.cormorant = entity;
    }

    @Override
    public void tick() {
        if (cormorant.isInWater()) {
            super.tick(); // smooth swimming logic
        } else {
