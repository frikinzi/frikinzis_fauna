...
public class WalkingSwimmingBirdAi {
    ...
    public static Brain<?> makeBrain(Brain<? extends WalkingSwimmingBird> brain,
        ...
        initIdleActivity(brain, entityType);
...
//                        Pair.of(1, new FindBreedTargetBehavior<>()),
//                        Pair.of(2, new LayEggBehavior<>()),
                        Pair.of(1, new AnimalMakeLove(entityType, 1.0F)),
                        Pair.of(3, new FollowTemptation(e -> SPEED_MULTIPLIER_WHEN_TEMPTED)),
                        Pair.of(4, StartAttacking.create(WalkingSwimmingBirdAi::findNearestValidAttackTarget)), // added
                        Pair.of(5, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, WalkingSwimmingBirdAi::getSpeedModifierFollowingAdult)),
                        Pair.of(6, TryFindWater.create(6, SPEED_MULTIPLIER_WHEN_IDLING_ON_LAND)),
    ...
    private static void initSwimActivity(Brain<? extends WalkingSwimmingBird> brain) {
        brain.addActivityWithConditions(Activity.SWIM,
                ImmutableList.of(
                        ...
                        Pair.of(1, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, WalkingSwimmingBirdAi::getSpeedModifierFollowingAdult)),
                        Pair.of(3, StartAttacking.create(WalkingSwimmingBirdAi::findNearestValidAttackTarget)), // added
                        Pair.of(4, TryFindLand.create(8, 1.2F)),
    ...
    private static void initFightActivity(Brain<? extends WalkingSwimmingBird> brain) {
        brain.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 0,
                ImmutableList.of(
                        ...
                        SetWalkTargetFromAttackTargetIfTargetOutOfReach.create(WalkingSwimmingBirdAi::getSpeedModifierChasing),
