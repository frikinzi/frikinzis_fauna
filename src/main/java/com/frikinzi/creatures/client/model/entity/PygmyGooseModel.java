...
public class PygmyGooseModel extends GeoModel<PygmyGooseEntity> {
    @Override
    public ResourceLocation getModelResource(PygmyGooseEntity object)
    {
        if (object.isBaby()) {
    ...
    @Override
    public ResourceLocation getTextureResource(PygmyGooseEntity object)
    {
        if (object.isBaby()) {
    ...
    @Override
    public ResourceLocation getAnimationResource(PygmyGooseEntity object)
    {
        if (object.isBaby()) {
