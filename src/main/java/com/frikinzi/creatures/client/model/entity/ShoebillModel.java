...
public class ShoebillModel extends GeoModel<ShoebillEntity> {
    @Override
    public ResourceLocation getModelResource(ShoebillEntity object)
    {
        if (object.isBaby()) {
    ...
    @Override
    public ResourceLocation getTextureResource(ShoebillEntity object)
    {
        if (object.isBaby()) {
    ...
    @Override
    public ResourceLocation getAnimationResource(ShoebillEntity object)
    {
        if (object.isBaby()) {
