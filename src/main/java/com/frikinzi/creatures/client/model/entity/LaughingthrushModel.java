...
public class LaughingthrushModel extends GeoModel<LaughingthrushEntity> {
    @Override
    public ResourceLocation getModelResource(LaughingthrushEntity object)
    {
        if (object.isFlying()) {
    ...
    @Override
    public ResourceLocation getTextureResource(LaughingthrushEntity object)
    {
        if (object.isFlying()) {
    ...
    @Override
    public ResourceLocation getAnimationResource(LaughingthrushEntity object)
    {
        if (object.isFlying()) {
