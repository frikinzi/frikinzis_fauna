...
public class RoeModel extends GeoModel<CreaturesRoeEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(CreaturesRoeEntity object)
    {
        return new ResourceLocation(Creatures.MODID, "geo/entity/roe/roe.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CreaturesRoeEntity object)
    {
    ...
    @Override
    public ResourceLocation getAnimationResource(CreaturesRoeEntity object)
    {
