...
public class GuppyRenderer extends GeoEntityRenderer<GuppyEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, GuppyEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
