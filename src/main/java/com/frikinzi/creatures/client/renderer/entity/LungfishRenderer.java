...
import com.frikinzi.creatures.client.model.entity.BarracudaModel;
import com.frikinzi.creatures.client.model.entity.LungfishModel;
...
public class LungfishRenderer extends GeoEntityRenderer<LungfishEntity>{
    public LungfishRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new LungfishModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, LungfishEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
