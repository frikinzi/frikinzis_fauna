...
public class ArowanaRenderer extends GeoEntityRenderer<ArowanaEntity>{
    public ArowanaRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ArowanaModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, ArowanaEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
