...
public class PelicanRenderer extends GeoEntityRenderer<PelicanEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, PelicanEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
