...
public class GhostCrabRenderer extends GeoEntityRenderer<GhostCrabEntity> {
    public GhostCrabRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new GhostCrabModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void defaultRender(PoseStack stack, GhostCrabEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
