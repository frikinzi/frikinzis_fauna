...
import com.frikinzi.creatures.client.model.entity.PheasantModel;
...
public class PheasantRenderer extends GeoEntityRenderer<PheasantEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, PheasantEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
