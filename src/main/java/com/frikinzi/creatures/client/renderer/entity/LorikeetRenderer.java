...
public class LorikeetRenderer extends GeoEntityRenderer<LorikeetEntity> {
    public LorikeetRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new LorikeetModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, LorikeetEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
