...
import com.frikinzi.creatures.client.model.entity.PeafowlModel;
...
public class PeafowlRenderer extends GeoEntityRenderer<PeafowlEntity>{
    public PeafowlRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new PeafowlModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, PeafowlEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
