...
import com.frikinzi.creatures.client.model.entity.ClownfishModel;
...
public class ClownfishRenderer extends GeoEntityRenderer<ClownfishEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, ClownfishEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
