...
import com.frikinzi.creatures.client.model.entity.EdibleCrabModel;
...
public class EdibleCrabRenderer extends GeoEntityRenderer<EdibleCrabEntity> {
    public EdibleCrabRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new EdibleCrabModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void defaultRender(PoseStack stack, EdibleCrabEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
