...
public class BarnOwlRenderer extends GeoEntityRenderer<BarnOwlEntity>{
    public BarnOwlRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new BarnOwlModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, BarnOwlEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
