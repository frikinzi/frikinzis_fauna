...
public class WildDuckRenderer extends GeoEntityRenderer<WildDuckEntity> {
    public WildDuckRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WildDuckModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, WildDuckEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
