...
public class BarracudaRenderer extends GeoEntityRenderer<BarracudaEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, BarracudaEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
