...
import com.frikinzi.creatures.client.model.entity.ConureModel;
import com.frikinzi.creatures.client.model.entity.RollerModel;
...
public class RollerRenderer extends GeoEntityRenderer<RollerEntity> {
    public RollerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new RollerModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, RollerEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
