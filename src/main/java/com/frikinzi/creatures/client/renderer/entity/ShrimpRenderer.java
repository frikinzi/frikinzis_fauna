...
import com.frikinzi.creatures.client.model.entity.ShrimpModel;
...
public class ShrimpRenderer extends GeoEntityRenderer<ShrimpEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, ShrimpEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
