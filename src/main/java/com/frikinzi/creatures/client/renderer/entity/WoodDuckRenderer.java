...
public class WoodDuckRenderer extends GeoEntityRenderer<WoodDuckEntity> {
    public WoodDuckRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WoodDuckModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, WoodDuckEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
