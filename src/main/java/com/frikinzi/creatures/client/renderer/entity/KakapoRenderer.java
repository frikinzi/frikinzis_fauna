...
import com.frikinzi.creatures.client.model.entity.KakapoModel;
...
public class KakapoRenderer extends GeoEntityRenderer<KakapoEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, KakapoEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
