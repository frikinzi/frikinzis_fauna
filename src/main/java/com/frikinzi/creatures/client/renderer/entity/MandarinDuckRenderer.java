...
public class MandarinDuckRenderer extends GeoEntityRenderer<MandarinDuckEntity> {
    public MandarinDuckRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new MandarinDuckModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, MandarinDuckEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
