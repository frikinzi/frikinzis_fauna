...
import com.frikinzi.creatures.client.model.entity.KingfisherModel;
...
public class KingfisherRenderer extends GeoEntityRenderer<KingfisherEntity> {
    public KingfisherRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new KingfisherModel());
        this.shadowRadius = 0.4F;
        this.addRenderLayer(new KingfisherHeldItemLayer(this));
    }

    @Override
    public void defaultRender(PoseStack stack, KingfisherEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
