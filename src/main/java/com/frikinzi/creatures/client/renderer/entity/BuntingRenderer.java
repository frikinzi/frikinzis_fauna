...
public class BuntingRenderer extends GeoEntityRenderer<BuntingEntity> {
    public BuntingRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new BuntingModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, BuntingEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
