...
public class SparrowRenderer extends GeoEntityRenderer<SparrowEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, SparrowEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
