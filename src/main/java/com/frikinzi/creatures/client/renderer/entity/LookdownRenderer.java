...
import com.frikinzi.creatures.client.model.entity.LookdownModel;
...
public class LookdownRenderer extends GeoEntityRenderer<LookdownEntity>{
    public LookdownRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new LookdownModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, LookdownEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
