...
public class FireGobyRenderer extends GeoEntityRenderer<FireGobyEntity>{
    public FireGobyRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FireGobyModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void defaultRender(PoseStack stack, FireGobyEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
