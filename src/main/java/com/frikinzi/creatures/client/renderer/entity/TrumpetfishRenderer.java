...
import com.frikinzi.creatures.client.model.entity.TrumpetfishModel;
...
public class TrumpetfishRenderer extends GeoEntityRenderer<TrumpetfishEntity>{
    public TrumpetfishRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TrumpetfishModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, TrumpetfishEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
