...
public class TigerBarbRenderer extends GeoEntityRenderer<TigerBarbEntity>{
    public TigerBarbRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TigerBarbModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void defaultRender(PoseStack stack, TigerBarbEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
