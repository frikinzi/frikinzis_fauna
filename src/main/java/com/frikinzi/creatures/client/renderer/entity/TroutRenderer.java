...
import com.frikinzi.creatures.client.model.entity.TroutModel;
...
public class TroutRenderer extends GeoEntityRenderer<TroutEntity>{
    public TroutRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TroutModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, TroutEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
