...
import com.frikinzi.creatures.client.model.entity.StiltModel;
...
public class StiltRenderer extends GeoEntityRenderer<StiltEntity> {
    public StiltRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new StiltModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, StiltEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
