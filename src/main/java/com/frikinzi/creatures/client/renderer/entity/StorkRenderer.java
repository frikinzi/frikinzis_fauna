...
public class StorkRenderer extends GeoEntityRenderer<StorkEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, StorkEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
