...
import com.frikinzi.creatures.client.model.entity.FiddlerCrabModel;
...
public class FiddlerCrabRenderer extends GeoEntityRenderer<FiddlerCrabEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, FiddlerCrabEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
