...
import com.frikinzi.creatures.client.model.entity.RailModel;
...
public class RailRenderer extends GeoEntityRenderer<RailEntity> {
    public RailRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new RailModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void defaultRender(PoseStack stack, RailEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
