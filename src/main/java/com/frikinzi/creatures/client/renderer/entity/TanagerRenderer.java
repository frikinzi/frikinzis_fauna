...
import com.frikinzi.creatures.client.model.entity.TanagerModel;
...
public class TanagerRenderer extends GeoEntityRenderer<TanagerEntity> {
    public TanagerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TanagerModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, TanagerEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
