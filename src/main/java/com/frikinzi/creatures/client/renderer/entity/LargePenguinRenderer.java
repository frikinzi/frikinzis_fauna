...
import com.frikinzi.creatures.client.model.entity.LargePenguinModel;
...
public class LargePenguinRenderer extends GeoEntityRenderer<LargePenguinEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, LargePenguinEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
