...
import com.frikinzi.creatures.client.model.entity.FlameAngelfishModel;
...
public class FlameAngelfishRenderer extends GeoEntityRenderer<FlameAngelfishEntity>{
    public FlameAngelfishRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FlameAngelfishModel());
        this.shadowRadius = 0.2F;
    }

    @Override
    public void defaultRender(PoseStack stack, FlameAngelfishEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
