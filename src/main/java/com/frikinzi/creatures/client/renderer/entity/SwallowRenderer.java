...
import com.frikinzi.creatures.client.model.entity.SwallowModel;
...
public class SwallowRenderer extends GeoEntityRenderer<SwallowEntity> {
    public SwallowRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SwallowModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, SwallowEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
