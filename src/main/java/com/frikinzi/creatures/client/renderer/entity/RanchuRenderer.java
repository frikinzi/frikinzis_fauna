...
import com.frikinzi.creatures.client.model.entity.GoldfishModel;
import com.frikinzi.creatures.client.model.entity.RanchuModel;
...
public class RanchuRenderer extends GeoEntityRenderer<RanchuEntity>{
    public RanchuRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new RanchuModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, RanchuEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
