...
//        event.registerEntityRenderer(CreaturesEntities.WHISTLINGDUCK.get(), WhistlingDuckRenderer::new);
...
//        event.registerEntityRenderer(CreaturesEntities.FRIGATE.get(), FrigateBirdRenderer::new);
...
//        event.registerEntityRenderer(CreaturesEntities.EGG.get(), CreaturesEggRenderer::new);
//        event.registerEntityRenderer(CreaturesEntities.ROE.get(), CreaturesRoeRenderer::new);
