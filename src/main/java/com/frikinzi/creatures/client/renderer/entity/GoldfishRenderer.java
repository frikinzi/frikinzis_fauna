...
public class GoldfishRenderer extends GeoEntityRenderer<GoldfishEntity>{
    ...
    @Override
    public void defaultRender(PoseStack stack, GoldfishEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
