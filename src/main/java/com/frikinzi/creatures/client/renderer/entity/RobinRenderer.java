...
import com.frikinzi.creatures.client.model.entity.RobinModel;
...
public class RobinRenderer extends GeoEntityRenderer<RobinEntity> {
    ...
    @Override
    public void defaultRender(PoseStack stack, RobinEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
