...
public class ChickadeeRenderer extends GeoEntityRenderer<ChickadeeEntity> {
    public ChickadeeRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new ChickadeeModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void defaultRender(PoseStack stack, ChickadeeEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer,
