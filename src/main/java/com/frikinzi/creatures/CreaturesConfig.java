...
public class CreaturesConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> tetra_hatch_chance;
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> bird_stealing;
    public static final ForgeConfigSpec.ConfigValue<Boolean> quiz_sound_q;
    ...
    static {
        ...
        BUILDER.push("Marabou");

        marabou_hatch_chance = BUILDER.comment("Hatch chance for each marabou egg").define("Marabou Hatch Chance", 0.3);
        marabou_clutch_size = BUILDER.comment("Max egg clutch size for marabou").define("Marabou Clutch Size", 4);

        BUILDER.pop();

        BUILDER.push("Tetra");

        tetra_hatch_chance = BUILDER.comment("Hatch chance for each tetra roe").define("Tetra Hatch Chance", 0.4);
        ...
        arapaima_mutation_chance = BUILDER.comment("Rarity of arapaima albino mutation from breeding/spawning").define("Arapaima Mutation Rarity", 50);
        bird_stealing = BUILDER.comment("Gameplay: Enable/disable birds like seagulls and skuas stealing from the player").define("Birds Steal", true);
        quiz_sound_q = BUILDER.comment("Gameplay: Enable/disable sound questions on Daily Quiz").define("Sound Quiz On", true);
