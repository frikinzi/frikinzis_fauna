...
import com.frikinzi.creatures.client.model.ShoebillModel;
...
public class ShoebillRenderer extends GeoEntityRenderer<ShoebillEntity> {
    public ShoebillRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new ShoebillModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(ShoebillEntity animatable, MatrixStack stackIn, float ticks,
