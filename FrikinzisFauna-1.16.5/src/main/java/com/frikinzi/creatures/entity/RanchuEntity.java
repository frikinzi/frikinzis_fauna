...
public class RanchuEntity extends FishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(RanchuEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    public RanchuEntity(EntityType<? extends RanchuEntity> p_i50246_1_, World p_i50246_2_) {
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(CreaturesItems.RANCHU_BUCKET);
    }
