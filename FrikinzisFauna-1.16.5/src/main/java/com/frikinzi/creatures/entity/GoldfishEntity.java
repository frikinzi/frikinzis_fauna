...
public class GoldfishEntity extends FishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(GoldfishEntity.class, DataSerializers.INT);
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(CreaturesItems.GOLDFISH_BUCKET);
    }
    ...
    public float getHatchChance() {
        return Double.valueOf(CreaturesConfig.goldfish_hatch_chance.get()).floatValue();
    }
