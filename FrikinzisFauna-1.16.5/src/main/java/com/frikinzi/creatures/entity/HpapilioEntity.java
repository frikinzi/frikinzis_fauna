...
public class HpapilioEntity extends AbstractCrabBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(HpapilioEntity.class, DataSerializers.INT);
    private static final DataParameter<Integer> GENDER = EntityDataManager.defineId(HpapilioEntity.class, DataSerializers.INT);
    private static final Ingredient FOOD_ITEMS = Ingredient.of(CreaturesItems.RAW_SHRIMP, Items.KELP, Items.DEAD_BUSH);
    private AnimationFactory factory = new AnimationFactory(this);

    public HpapilioEntity(EntityType<? extends HpapilioEntity> p_i48567_1_, World p_i48567_2_) {
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        HpapilioEntity ghostcrabentity = (HpapilioEntity) getType().create(p_241840_1_);
    ...
    public String getSpeciesName() {
        ITextComponent s1 = new TranslationTextComponent("entity.creatures.hpapilio");
        return s1.getString();
    }
