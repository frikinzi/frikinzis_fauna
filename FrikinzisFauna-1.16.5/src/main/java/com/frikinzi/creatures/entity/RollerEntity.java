...
=======
    public static Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslationTextComponent("message.creatures.lilac"),
            2, new TranslationTextComponent("message.creatures.europeanroller"),
            3, new TranslationTextComponent("message.creatures.indochinese"),
            4, new TranslationTextComponent("message.creatures.purplewinged"),
            5, new TranslationTextComponent("message.creatures.bluebellied")
    );
>>>>>>> Stashed changes
