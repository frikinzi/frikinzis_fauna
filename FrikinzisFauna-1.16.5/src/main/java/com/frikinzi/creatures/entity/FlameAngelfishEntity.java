...
public class FlameAngelfishEntity extends FishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(FlameAngelfishEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    public FlameAngelfishEntity(EntityType<? extends FlameAngelfishEntity> p_i50246_1_, World p_i50246_2_) {
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(CreaturesItems.FLAME_ANGELFISH_BUCKET);
    }
