...
public class CreaturesFollowGoal extends Goal {
    ...
    public CreaturesFollowGoal(TameableEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
    ...
    private boolean maybeTeleportTo(int p_226328_1_, int p_226328_2_, int p_226328_3_) {
        if (Math.abs((double)p_226328_1_ - this.owner.getX()) < CreaturesConfig.teleporting_distance.get() && Math.abs((double)p_226328_3_ - this.owner.getZ()) < CreaturesConfig.teleporting_distance.get()) {
            return false;
    ...
    private boolean canTeleportTo(BlockPos p_226329_1_) {
        ...
        if (CreaturesConfig.teleporting.get() == false) {
            return false;
        }
        else {
