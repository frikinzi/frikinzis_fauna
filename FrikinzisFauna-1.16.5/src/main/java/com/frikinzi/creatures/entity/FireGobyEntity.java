...
public class FireGobyEntity extends FishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(FireGobyEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    public FireGobyEntity(EntityType<? extends FireGobyEntity> p_i50246_1_, World p_i50246_2_) {
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(CreaturesItems.FIRE_GOBY_BUCKET);
    }
