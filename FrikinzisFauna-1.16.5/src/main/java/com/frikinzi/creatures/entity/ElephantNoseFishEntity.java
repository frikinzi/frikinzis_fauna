...
public class ElephantNoseFishEntity extends GroupFishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(ElephantNoseFishEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    public ElephantNoseFishEntity(EntityType<? extends ElephantNoseFishEntity> p_i50246_1_, World p_i50246_2_) {
