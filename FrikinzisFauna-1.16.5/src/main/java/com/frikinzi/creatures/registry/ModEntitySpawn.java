...
public class ModEntitySpawn {
    ...
    public static void onBiomesLoad(final BiomeLoadingEvent event) {
        ...
        if (CreaturesConfig.koi_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
        ...
        if (CreaturesConfig.dottyback_spawns.get() == true && types.contains(BiomeDictionary.Type.OCEAN) && types.contains(BiomeDictionary.Type.HOT)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.red_snapper_spawns.get() == true && types.contains(BiomeDictionary.Type.OCEAN) && (!types.contains(BiomeDictionary.Type.COLD))) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.pike_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.lovebird_spawns.get() == true && types.contains(BiomeDictionary.Type.SAVANNA)) {
        ...
        if (CreaturesConfig.shrimp_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.gourami_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.arowana_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.ghost_crab_spawns.get() == true && types.contains(BiomeDictionary.Type.BEACH) && !types.contains(BiomeDictionary.Type.COLD)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.lorikeet_spawns.get() == true && !types.contains(BiomeDictionary.Type.NETHER) && (types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.JUNGLE))) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.conure_spawns.get() == true  && !types.contains(BiomeDictionary.Type.NETHER) && (types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.JUNGLE))) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.spoonbill_spawns.get() == true && types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.dove_spawns.get() == true && !types.contains(BiomeDictionary.Type.NETHER) && (types.contains(BiomeDictionary.Type.JUNGLE) || types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.PLAINS))) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.mandarin_duck_spawns.get() == true && !types.contains(BiomeDictionary.Type.NETHER) && (types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.FOREST))) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.kakapo_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.raven_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.fairywren_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.golden_eagle_spawns.get() == true && (types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.DRY) || types.contains(BiomeDictionary.Type.PLAINS) || types.contains(BiomeDictionary.Type.MESA) || types.contains(BiomeDictionary.Type.MOUNTAIN)) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.gyrfalcon_spawns.get() == true && types.contains(BiomeDictionary.Type.SNOWY)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.red_kite_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.stellers_sea_eagle_spawns.get() == true && types.contains(BiomeDictionary.Type.SNOWY) && types.contains(BiomeDictionary.Type.BEACH)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.pygmy_falcon_spawns.get() == true && types.contains(BiomeDictionary.Type.DRY) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.barn_owl_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.goldfish_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.ranchu_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER) || types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.wild_duck_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.chickadee_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) && !types.contains(BiomeDictionary.Type.NETHER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.pygmy_goose_spawns.get() == true && types.contains(BiomeDictionary.Type.SWAMP)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.swallow_spawns.get() == true && !types.contains(BiomeDictionary.Type.NETHER) && types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.PLAINS)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.fire_goby_spawns.get() == true && types.contains(BiomeDictionary.Type.OCEAN) && types.contains(BiomeDictionary.Type.HOT)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.blue_tang_spawns.get() == true && types.contains(BiomeDictionary.Type.OCEAN) && types.contains(BiomeDictionary.Type.HOT)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.flame_angelfish_spawns.get() == true && types.contains(BiomeDictionary.Type.OCEAN) && types.contains(BiomeDictionary.Type.HOT)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.trout_spawns.get() == true && types.contains(BiomeDictionary.Type.RIVER)) {
            spawns.addSpawn(EntityClassification.WATER_AMBIENT,
        ...
        if (CreaturesConfig.fiddler_crab_spawns.get() == true && types.contains(BiomeDictionary.Type.BEACH) && !types.contains(BiomeDictionary.Type.COLD)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.ibis_spawns.get() == true && types.contains(BiomeDictionary.Type.SWAMP) || types.contains(BiomeDictionary.Type.RIVER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.wood_duck_spawns.get() == true && types.contains(BiomeDictionary.Type.SWAMP) || types.contains(BiomeDictionary.Type.RIVER)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.peafowl_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.sparrow_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST) || types.contains(BiomeDictionary.Type.JUNGLE) || types.contains(BiomeDictionary.Type.DRY)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.bushtit_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.laughingthrush_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.eagleowl_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.robin_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
        ...
        if (CreaturesConfig.magpie_spawns.get() == true && types.contains(BiomeDictionary.Type.FOREST)) {
            spawns.addSpawn(EntityClassification.CREATURE,
