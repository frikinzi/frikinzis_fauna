    ...
    public static void onLootTablesLoaded(LootTableLoadEvent event)
    {
        if (event.getName().equals(LootTableList.GAMEPLAY_FISHING_FISH))
        {
            ...
            if (main != null)
            {
                ...
                main.addEntry(new LootEntryItem(ItemInit.RAW_KOI, 10, 0, new LootFunction[0], new LootCondition[] {new RandomChance(0.1F)}, "creatures:koi_loot"));
                ...
                main.addEntry(new LootEntryItem(ItemInit.RAW_AROWANA, 10, 0, new LootFunction[0], new LootCondition[] {new RandomChance(0.1F)}, "creatures:arowana_loot"));
            }
