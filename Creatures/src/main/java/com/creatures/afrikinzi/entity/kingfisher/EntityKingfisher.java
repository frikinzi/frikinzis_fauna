...
public class EntityKingfisher extends AbstractCreaturesNonTameable implements IAnimatable, EntityFlying, ICreaturesEntity {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityKingfisher.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntityKingfisher.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityKingfisher.class, DataSerializers.VARINT);
    ...
    public EntityKingfisher(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityGuppy.class, true));
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityKoi.class, true));
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityGourami.class, true));
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityKingfisher))
        {
            return false;
        }
        else
        {
            EntityKingfisher entityibis = (EntityKingfisher)otherAnimal;
    ...
    {
        EntityKingfisher entityibis = new EntityKingfisher(this.world);
    ...
    {
        return MathHelper.clamp(((Integer)this.dataManager.get(GENDER)).intValue(), 0, 2);
    }
    ...
    public SoundEvent getAmbientSound()
    {
        if (!this.isSleeping()) {
            ...
            return SoundsHandler.KINGFISHER_AMBIENT;
        } else {
            return null;
        }
    }
    ...
    public String getSpeciesName() {
        if (this.getVariant() == 1) {
            String s1 = I18n.format("message.creatures.commonkingfisher");
            return s1;
        }
        else if (this.getVariant() == 2) {
            String s1 = I18n.format("message.creatures.dwarforiental");
            return s1;
        }
        else if (this.getVariant() == 3) {
            String s1 = I18n.format("message.creatures.forestkingfisher");
            return s1;
        }
        else if (this.getVariant() == 4) {
            String s1 = I18n.format("message.creatures.beltedkingfisher");
            return s1;
        }
        else if (this.getVariant() == 5) {
            String s1 = I18n.format("message.creatures.marquesas");
            return s1;
        }
        else if (this.getVariant() == 6) {
            String s1 = I18n.format("message.creatures.spottedkingfisher");
            return s1;
        } else {
            return "Unknown";
        }
