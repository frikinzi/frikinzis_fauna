...
public class EntityLapwing extends AbstractCreaturesNonTameable implements IAnimatable, EntityFlying, ICreaturesEntity {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityLapwing.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntityLapwing.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityLapwing.class, DataSerializers.VARINT);
    ...
    public EntityLapwing(World worldIn)
    {
        super(worldIn);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityLapwing))
        {
            return false;
        }
        else
        {
            EntityLapwing entityibis = (EntityLapwing)otherAnimal;
    ...
    {
        EntityLapwing entityibis = new EntityLapwing(this.world);
    ...
    public SoundEvent getAmbientSound()
    {
        if (!this.isSleeping()) {
            ...
            return SoundsHandler.LAPWING_AMBIENT;
        } else {
            return null;
        }
    }
    ...
    public String getSpeciesName() {
        if (this.getVariant() == 1) {
            String s1 = I18n.format("message.creatures.longtoed");
            return s1;
        }
        else if (this.getVariant() == 2) {
            String s1 = I18n.format("message.creatures.senegal");
            return s1;
        }
        else if (this.getVariant() == 3) {
            String s1 = I18n.format("message.creatures.northern");
            return s1;
        }
        else if (this.getVariant() == 4) {
            String s1 = I18n.format("message.creatures.masked");
            return s1;
        }
        else if (this.getVariant() == 5) {
            String s1 = I18n.format("message.creatures.sociable");
            return s1;
        } else {
            return "Unknown";
        }
