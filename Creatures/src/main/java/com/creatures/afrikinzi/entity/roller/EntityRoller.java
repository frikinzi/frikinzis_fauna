...
public class EntityRoller extends AbstractCreaturesNonTameable implements IAnimatable, EntityFlying, ICreaturesEntity {
    ...
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityRoller.class, DataSerializers.VARINT);
    ...
    public EntityRoller(World worldIn)
    {
        super(worldIn);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityRoller))
        {
            return false;
        }
        else
        {
            EntityRoller entityroller = (EntityRoller)otherAnimal;
    ...
    public String getSpeciesName() {
        if (this.getVariant() == 1) {
            String s1 = I18n.format("message.creatures.lilac");
            return s1;
        }
        else if (this.getVariant() == 2) {
            String s1 = I18n.format("message.creatures.europeanroller");
            return s1;
        }
        else if (this.getVariant() == 3) {
            String s1 = I18n.format("message.creatures.indochinese");
            return s1;
        }
        else if (this.getVariant() == 4) {
            String s1 = I18n.format("message.creatures.purplewinged");
            return s1;
        }
        else if (this.getVariant() == 5) {
            String s1 = I18n.format("message.creatures.bluebellied");
            return s1;
        } else {
            return "Unknown";
        }
