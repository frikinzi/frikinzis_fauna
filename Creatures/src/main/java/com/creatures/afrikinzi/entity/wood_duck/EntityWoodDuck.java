...
public class EntityWoodDuck extends AbstractCreaturesNonTameable implements IAnimatable, ICreaturesEntity {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityWoodDuck.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntityWoodDuck.class, DataSerializers.BOOLEAN);
    private EntityAITempt aiTempt;

    public EntityWoodDuck(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(1, new CreaturesAISwimming(this));
    ...
    public EntityWoodDuck createChild(EntityAgeable ageable)
    {
        EntityWoodDuck entitymandarinduck = new EntityWoodDuck(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityWoodDuck))
        {
            return false;
        }
        else
        {
            EntityWoodDuck entitymandarinduck = (EntityWoodDuck)otherAnimal;
    ...
    {
        if (!this.isSleeping()) {
            return this.rand.nextInt(4) == 0 ? SoundsHandler.WOOD_DUCK_AMBIENT1 : SoundsHandler.WOOD_DUCK_AMBIENT2;
        } else {
            return null;
        }
    }
