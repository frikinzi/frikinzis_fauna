...
public class EntitySpoonbill extends EntityAnimal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntitySpoonbill.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntitySpoonbill.class, DataSerializers.BOOLEAN);

    public EntitySpoonbill(World worldIn)
    {
        super(worldIn);
        this.setSize(1F, 2F);
    }
