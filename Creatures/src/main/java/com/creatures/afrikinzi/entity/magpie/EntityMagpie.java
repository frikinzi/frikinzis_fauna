...
public class EntityMagpie extends AbstractCreaturesNonTameable implements EntityFlying, IAnimatable, ICreaturesEntity {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityMagpie.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntityMagpie.class, DataSerializers.BOOLEAN);
    public float flap;
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityMagpie))
        {
            return false;
        }
        else
        {
            EntityMagpie entitychickadee = (EntityMagpie)otherAnimal;
    ...
    {
        EntityMagpie entitymagpie = new EntityMagpie(this.world);
        entitymagpie.setVariant(this.getVariant());
        entitymagpie.setGender(this.rand.nextInt(2));
    ...
    {
        if (!this.isSleeping()) {
            return SoundsHandler.MAGPIE_AMBIENT;
        } else {
            return null;
        }
    }
