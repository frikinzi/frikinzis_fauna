...
public class EntitySkua extends AbstractCreaturesNonTameable implements IAnimatable, EntityFlying, ICreaturesEntity {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntitySkua.class, DataSerializers.VARINT);
    protected static final DataParameter<Boolean> SLEEPING = EntityDataManager.createKey(EntitySkua.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntitySkua.class, DataSerializers.VARINT);
    private static final Set<Item> TAME_ITEMS = Sets.newHashSet(Items.CHICKEN, ItemInit.RAW_SMALL_WILD_BIRD_MEAT, Items.EGG, ItemInit.RAW_TROUT);
    public float flap;
    ...
    public EntitySkua(World worldIn)
    {
        super(worldIn);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntitySkua))
        {
            return false;
        }
        else
        {
            EntitySkua entityibis = (EntitySkua)otherAnimal;
    ...
    {
        EntitySkua entityibis = new EntitySkua(this.world);
    ...
    public SoundEvent getAmbientSound()
    {
        if (!this.isSleeping()) {
            ...
            return SoundsHandler.SKUA_AMBIENT;
        } else {
            return null;
        }
    }
    ...
    public String getSpeciesName() {
        if (this.getVariant() == 1) {
            String s1 = I18n.format("message.creatures.southpolar");
            return s1;
        }
        else if (this.getVariant() == 2) {
            String s1 = I18n.format("message.creatures.chilean");
            return s1;
        }
        else if (this.getVariant() == 3) {
            String s1 = I18n.format("message.creatures.greatskua");
            return s1;
        }
        else if (this.getVariant() == 4) {
            String s1 = I18n.format("message.creatures.brownskua");
            return s1;
        } else {
            return "Unknown";
        }
